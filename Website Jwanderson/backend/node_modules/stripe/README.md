...
<!-- prettier-ignore -->
```js
const stripe = require('stripe')('***REMOVED***_...');
...
const stripe = new Stripe('***REMOVED***_...');
...
```javascript
const client = new Stripe('***REMOVED***_...');
...
```bash
export STRIPE_TEST_API_KEY='***REMOVED***....'
just test
# or: yarn test
```
